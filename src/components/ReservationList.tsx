            ...
            <table className="table-auto border-collapse border border-slate-500 text-white w-full text-center">
                ...
                <tbody>
                    {reservationHistoryTable &&
                        reservationHistoryTable.map((reservationHistory) => {
                            return (
                                <tr
                                    key={reservationHistory.reservationId}
                                    className="cursor-pointer hover:bg-[#363636]"
                                    onClick={() => navigate(`/reservation-detail/${reservationHistory.reservationId}`)}
                                >
